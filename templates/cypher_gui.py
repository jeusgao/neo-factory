...
def _match():
    ...
    output = st.multiselect('选择输出项(RETURN)', ['a: Start node', 'b: End node', 'r: Relationship'], default=['a: Start node'])
    ...
    st.success(f'!!!match BOOM!!! {_cypher}')
